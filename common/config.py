...
def _add_train_args(parser):
    ...
    parser.add_argument('--language', type=str, default='russian', help='language: {english/russian}')
    parser.add_argument('--project_path', type=str, default='torchASN/', help='Project path')
    ...
    parser.add_argument('--dev_file', default='data/sparql/dev.bin',  type=str, help='path to the dev source file')
    parser.add_argument('--enc_hid_size', default=258,  type=int, help='encoder hidden size')
    parser.add_argument('--num_warmup_steps', default=1000, type=int, help='num of warmups to target lr')
    parser.add_argument('--warm_up_init_learning_rate', default=0.0005, type=int, help='num of warmups to target lr for BERT')
    parser.add_argument('--bert_finetune_rate', default=0.00006, type=int, help='finetune step')
    parser.add_argument('--bert_warmup_init_finetuning_learning_rate', default=1000, type=int, help='num of warmups to target lr for BERT')
    parser.add_argument('--src_emb_size', default=258,  type=int, help='sentence embedding size')
    parser.add_argument('--field_emb_size', default=258, type=int, help='field embedding size')
    ...
    parser.add_argument('--sch_step_size', type=int, default=29, help='lr scheduler step size')
